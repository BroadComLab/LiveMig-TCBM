...
% -------------------------------------------------------------------
% ----- VARIABLES --------------------------------------------------
Imax        =   7;              % Final round index
N0          =   5*10^2;         % Iteration index [] 
...
amax        =   0.1;      %2*10^(-4);%5*10^(-7);% buono tra 5*10(-7) e 10^(-6)
passoTou    =   100;
DeltaTM     =   141;%2*10^200;%141;%2*10^300;%94.6;%21.33;%2*10^600;2*10^300;       %0.17*10^(1); % maximum tolerated Time Migration
DeltaDT     =   1.1*10^-4;%10^200;%10^300;%0.1; %1.17*10^-3;%19.31;%10^600;         %11.63636364; % maximum tolerated down-time
