...
amax        =   7*10^(-4);      %2*10^(-4);%5*10^(-7);% buono tra 5*10(-7) e 10^(-6)
passoTou    =   100;
DeltaTM     =   2*10^300;%94.6;%21.33;%2*10^600;2*10^300;       %0.17*10^(1); % maximum tolerated Time Migration
DeltaDT     =   10^300;%0.1; %1.17*10^-3;%19.31;%10^600;         %11.63636364; % maximum tolerated down-time
beta        =   10.9;%5.17;            %1.05; %1.2; %beta_i(1);
